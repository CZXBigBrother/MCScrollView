...
@interface PortaitViewController ()

@end

@implementation PortaitViewController
...
//                         @"http://s.mangatown.com/store/manga/9/58-612.0/compressed/l005.jpg"];
    ...
    MCScrollView *MC=[[MCScrollView alloc]initWithFrame:CGRectMake(0, 0, [UIScreen mainScreen].bounds.size.width, [UIScreen mainScreen].bounds.size.height-5) cycleDirection:CycleDirectionPortait pictures:arr isNetworkLink:NO];
